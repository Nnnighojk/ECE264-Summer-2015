...
int main(int argc, char * * argv)
{
    ...
    int lenc = 4;
    int x1 = arrayIndexRFind(1, haystack, lenc); // x1 == 0
    int x2 = arrayIndexRFind(4, haystack, lenc); // x2 == 3
    int x3 = arrayIndexRFind(6, haystack, lenc);
   ...
   int ind2 = arrayFindSmallest(array23, len);
